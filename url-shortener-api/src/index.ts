...
const shortUrlsCreatedCounter = new client.Counter({
...
const activeShortUrlsGauge = new client.Gauge({
...
function updateActiveShortUrlsGauge(): void {
...
app.get("/api/urls/:code", (req: Request, res: Response) => {
...
app.delete("/api/urls", (_req: Request, res: Response) => {
